...
PetscErrorCode calc_kinematic_winkler(){
    ...
    ierr = DMDAVecGetArray(da_Veloc, local_V_curr, &VV_curr); CHKERRQ(ierr);
    ...
    ierr = DMDAVecRestoreArray(da_Veloc, local_V_curr, &VV_curr); CHKERRQ(ierr);
